    ...
    <div className="final-section grid md:grid-cols-2 gap-10 items-center mt-20 px-10 py-16 bg-orange-100 rounded-xl shadow-lg">
      ...
      <div className="text-content space-y-6">
        <h1 className="text-4xl md:text-5xl font-bold text-gray-800">
          About Our <span className="text-orange-600">Restaurant</span>
        </h1>
        ...
        <button className="bg-orange-500 text-white py-2 px-6 rounded-full font-semibold hover:bg-orange-600 transition duration-300">
          Learn More
        </button>
      </div>
